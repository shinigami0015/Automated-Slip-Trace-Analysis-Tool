...
class SidebarHeader(QWidget):
    ...
    def paintEvent(self, _):
        ...
        p.drawText(cx + r + 16, 14, W - cx - r - 24, 32, Qt.AlignmentFlag.AlignLeft | Qt.AlignmentFlag.AlignVCenter, "ASTA")
...
class MainWindow(QMainWindow):
    ...
    def _validate_inputs(self) -> bool:
        ...
        if s and not os.path.isdir(s): return self._err("Invalid Scripts", "Select a valid scripts folder, or leave it empty to use internal scripts.")
    ...
    def _zip_results(self):
        ...
        save_path, _ = QFileDialog.getSaveFileName(self, "Save Zip", os.path.join(out, "ASTA_Results.zip"), "Zip Files (*.zip)")
        if save_path:
